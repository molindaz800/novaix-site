(() => {
  ...
  E("Automatizar no debe significar perder control. Nuestro enfoque pone la privacidad, la trazabilidad y la minimización de datos en el centro de cada agente.", "Automatizar no debe significar perder control. Nuestro enfoque pone la privacidad, la trazabilidad y la minimización de datos en el centro de cada agente.", "Automation should not mean losing control. Our approach puts privacy, traceability and data minimization at the center of every agent.");
  ...
  E("IA práctica, cercana y con impacto real", "IA práctica, cercana y con impacto real", "Practical, accessible AI with real impact");
